  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.log('Saving questionnaire data:', {
        ...
        materialsWithISBN:
          submissionData.materials?.filter((m) => m.materialBarcode).length ||
          0,
        isbns:
          submissionData.materials?.map((m) => ({
            name: m.materialName,
            isbn: m.materialBarcode,
          })) || [],
      });
    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div>
        ...
        <input
          ...
          onChange={(e) =>
            handleInputChange('universityDepartment', e.target.value)
          }
          className="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 dark:bg-gray-800 dark:text-white"
          placeholder="例：経済学部"
          required
      ...
      <div>
        ...
        <input
          ...
          onChange={(e) =>
            handleInputChange('universityDomain', e.target.value)
          }
          className="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 dark:bg-gray-800 dark:text-white"
